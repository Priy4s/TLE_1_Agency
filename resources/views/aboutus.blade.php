...
<section class="container py-5 w-[90%] mx-[5%]">
    ...
    <div class="text-center">
        <h2 class="font-bold mb-4 text-3xl text-left">
            <span
                class="speaker-icon ml-5"
                aria-label="Click to hear, the 3 principles, out loud"
                role="button"
                tabindex="0"
                data-text="{{ "3 Principles: What does Open Hiring believe in? 1, It works better without prejudgments. Opportunities are given based on motivation, not background. This creates a fair and inclusive job market. 2. We trust each other. Trusting job seekers helps organizations become more resilient, inclusive, and diverse. 3. Growth happens together. By creating an environment of support and learning, we grow stronger as a team. By creating an environment of support and learning, we grow stronger as a team." }}">
            </span>
            3 Principles: What does Open Hiring believe in?</h2>
        <div class="row g-4">
            <!-- Principes 1 -->
